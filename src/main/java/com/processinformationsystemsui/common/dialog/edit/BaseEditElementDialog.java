package com.processinformationsystemsui.common.dialog.edit;
...
public class BaseEditElementDialog extends JDialog {
    protected final List<JLabel> labels;
    protected final List<JTextField> textFieldList;
    public BaseEditElementDialog(JFrame parentFrame, String title, Dimensions dimensions) {
        super(parentFrame, title, true);

        ValidationErrorMessageDialog validationErrorMessageDialog = new ValidationErrorMessageDialog(BaseEditElementDialog.this);
        InformationMessageDialog informationMessageDialog = new InformationMessageDialog(BaseEditElementDialog.this);
